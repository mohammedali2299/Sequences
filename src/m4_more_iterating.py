...
def run_test_count_positive_sines():
    ...
    # ------------------------------------------------------------------
    # doneTODO: 6. Implement this TEST function.
    ...
    expected = 5
    actual = count_positive_sines([math.pi/3, math.pi/4, math.pi/5, math.pi/6, math.pi/7])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 4
    actual = sum_first_n([2, 2, 3, 5], 2)
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)

    # Test 9:
    expected = 2
    actual = sum_first_n([2, 2, 3, 5], 1)
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
